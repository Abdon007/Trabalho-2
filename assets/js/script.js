onload = () => {
  ...
  document.querySelector("#btn-0").onclick = () => lançamentos();
  document.querySelector("#btn-1").onclick = () => plataformas();
};


var url0 =
  "https://api.rawg.io/api/games?page=1&page_size=10&key=f7d3f4d12f124e35a5b40ea0ff8a3a75";
async function lançamentos() {
  let str = "";
...
var url1 = `https://api.rawg.io/api/platforms?page=1&page_size=3&key=f7d3f4d12f124e35a5b40ea0ff8a3a75`;
